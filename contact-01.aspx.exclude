<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact-01.aspx.cs" Inherits="contact_01" %>
    ...
    <div class="container">
      ...
      <div id="navbar-collapse-grid" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"> <a href="#" data-toggle="dropdown" class="dropdown-toggle js-activated">Contact<b class="caret"></b></a>
            <ul class="dropdown-menu">

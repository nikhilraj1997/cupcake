    ...
    <div class="container">
      ...
      <div id="navbar-collapse-grid" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"> <a href="#" data-toggle="dropdown" class="dropdown-toggle js-activated">Blog<b class="caret"></b></a>
            <ul class="dropdown-menu">
      ...
      <div class="col-md-9"> 
        ...
        <article>
          ...
          <div class="row">
            ...
            <div class="col-sm-11 col-xs-10 meta">
              <h2><a href="blog-post.aspx">This is a video post</a></h2>
              ...
              <a href="blog-post.aspx" class="btn btn-primary pull-right">Read More</a> </div>
          </div>
        </article>
        <!-- Article Image-->
        <article> <a href="blog-post.aspx" class="mask"><img src="images/blog/940x344.gif" alt="image" class="img-responsive zoom-img"></a>
          <div class="row">
            <div class="col-sm-1 col-xs-2 meta">
              <div class="meta-date"><span>Apr</span>14</div>
            </div>
            <div class="col-sm-11 col-xs-10 meta">
              <h2><a href="blog-post.aspx">An image post</a></h2>
              <span class="meta-author"><i class="fa fa-user"></i><a href="#">Starhotel</a></span> <span class="meta-category"><i class="fa fa-pencil"></i><a href="#">Hotel business</a></span> <span class="meta-comments"><i class="fa fa-comment"></i><a href="#">3 Comments</a></span>
              <p class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sed turpis neque. In auctor, odio eget luctus lobortis, sapien erat blandit felis, eget volutpat augue felis in purus. Aliquam ultricies est id ultricies facilisis. Maecenas tempus... </p>
              <a href="blog-post.aspx" class="btn btn-primary pull-right">Read More</a> </div>
          </div>
        ...
        <article>
          ...
          <div class="row">
            ...
            <div class="col-sm-11 col-xs-10 meta">
              <h2><a href="blog-post.aspx">Audio included post</a></h2>
              <span class="meta-author"><i class="fa fa-user"></i><a href="#">Starhotel</a></span> <span class="meta-category"><i class="fa fa-pencil"></i><a href="#">Hotel business</a></span> <span class="meta-comments"><i class="fa fa-comment"></i><a href="#">3 Comments</a></span>
              <p class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sed turpis neque. In auctor, odio eget luctus lobortis, sapien erat blandit felis, eget volutpat augue felis in purus. Aliquam ultricies est id ultricies facilisis. Maecenas tempus... </p>
              <a href="blog-post.aspx" class="btn btn-primary pull-right">Read More</a> </div>
          </div>
        ...
        <article>
          <section class="standard-slider">
            <div id="owl-standard" class="owl-carousel">
              <div class="item"><a href="blog-post.aspx"><img src="images/blog/940x344.gif" alt="image" class="img-responsive zoom-img"></a></div>
              <div class="item"><a href="blog-post.aspx"><img src="images/blog/940x344.gif" alt="image" class="img-responsive zoom-img"></a></div>
            </div>
          </section>
          <div class="row">
            ...
            <div class="col-md-11 col-xs-10 meta">
              <h2><a href="blog-post.aspx">And this is a slider post</a></h2>
              <span class="meta-author"><i class="fa fa-user"></i><a href="#">Starhotel</a></span> <span class="meta-category"><i class="fa fa-pencil"></i><a href="#">Hotel business</a></span> <span class="meta-comments"><i class="fa fa-comment"></i><a href="#">3 Comments</a></span>
              <p class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sed turpis neque. In auctor, odio eget luctus lobortis, sapien erat blandit felis, eget volutpat augue felis in purus. Aliquam ultricies est id ultricies facilisis. Maecenas tempus... </p>
              <a href="blog-post.aspx" class="btn btn-primary pull-right">Read More</a> </div>
          </div>
      ...
      <div class="col-md-3">
        ...
        <div class="widget clearfix">
          ...
          <ul class="list-unstyled">
            <li>
              <article>
                <div class="news-thumb"> <a href="blog-post.aspx"><img src="images/blog/65x65.gif" alt="65x65"></a> </div>
                <div class="news-content clearfix">
                  <h4><a href="blog-post.aspx">This is a video post</a></h4>
                  <span><a href="blog-post.aspx">April 15 2014</a></span> </div>
              </article>
            </li>
            <li>
              <article>
                <div class="news-thumb"> <a href="blog-post.aspx"><img src="images/blog/65x65.gif" alt="65x65"></a> </div>
                <div class="news-content clearfix">
                  <h4><a href="blog-post.aspx">An image post</a></h4>
                  <span><a href="blog-post.aspx">April 14 2014</a></span> </div>
              </article>
            </li>
            <li>
              <article>
                <div class="news-thumb"> <a href="blog-post.aspx"><img src="images/blog/65x65.gif" alt="65x65"></a> </div>
                <div class="news-content clearfix">
                  <h4><a href="blog-post.aspx">Audio included post</a></h4>
                  <span><a href="blog-post.aspx">April 12 2014</a></span> </div>
              </article>
            </li>
          </ul>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminlogin.aspx.cs" Inherits="adminlogin" EnableSessionState="True" %>
...
<section class="rooms mt100">
  <div class="container">
      <div runat="server" id="logFail" style="color:#ce4242;"></div>
      <form runat="server" class="form" role="form" name="reservationform" id="reservationform">
          <div id="message"></div>
          ...
          <div class="row">
              <div class="col-sm-3">
                  <div class="form-group">
                      ...
                      <input runat="server" name="username" type="text" id="email" value="" class="form-control" placeholder="Please enter your username" />
                  </div>
              </div>
              <div class="col-sm-3">
                  <div class="form-group">
                      <label for="room">Password</label>
                      <input runat="server" name="password" type="password" id="password" value="" class="form-control" placeholder="Please enter your password" />
                      
                  </div>
              </div>
              <div class="col-sm-2">
                  <asp:Button runat="server" class="btn btn-primary btn-block" ID="login" Text="Login" UseSubmitBehavior="false" OnClick="login_Click"  style="margin-top: 5.7vh;" />

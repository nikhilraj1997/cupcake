...
<section id="reservation-form">
  <div class="container">
    <div class="row">
      <div class="col-md-12">           
        <form class="form-inline reservation-horizontal clearfix" runat="server" name="reservationform" id="reservationform">
              ...
              <div class="form-group">
                <div class="guests-select">
                  ...
                  <div class="guests">
                    ...
                    <asp:Button class="btn btn-default button-save btn-block" runat="server" Text="Save" />
                  </div>
                </div>
              </div>
            </div>
            <div class="col-sm-2">
                <asp:Button id="Button1" runat="server" Text="Button" class="btn btn-primary btn-block" OnClick="process" />
            </div>
          </div>
        </form>
      </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blog-post.aspx.cs" Inherits="blog_post" %>
    ...
    <section class="blog mt50">
      <div class="col-md-9"> 
        ...
        <section class="blog-author clearfix">
          ...
          <img src="images/blog/82x82.gif" alt="Author"  class="img-circle"/>
        ...
        <section class="comments mt50">
          ...
          <div class="comment"> <a href="#">
            ...
            <div class="avatar"> <img src="images/blog/50x50.gif" alt="50x50.gif" class="img-circle"/> </div>
          ...
          <div class="reply">
            <div class="comment"> <a href="#">
              ...
              <div class="avatar"> <img src="images/blog/50x50.gif" alt="comment-02" class="img-circle"/> </div>
              <div class="comment-text">
                <div class="author">
          ...
          <div class="comment"> <a href="#">
            ...
            <div class="avatar"> <img src="images/blog/50x50.gif" alt="comment-03" class="img-circle"/> </div>
            <div class="comment-text">
              <div class="author">
